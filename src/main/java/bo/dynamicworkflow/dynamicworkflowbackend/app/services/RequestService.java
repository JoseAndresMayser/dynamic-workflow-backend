...
public interface RequestService {
    ...
    FileResponseDto downloadRequestFormByRequestId(Integer requestId) throws RequestNotFoundException,
            FileReadException;

    RequestDetailResponseDto getRequestDetailByRequestId(Integer requestId) throws RequestNotFoundException;
